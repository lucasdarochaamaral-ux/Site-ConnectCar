        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className={`transition-all duration-1000 delay-800 ${
            ...
            <img
              ...
              alt="Clientes satisfeitos da ConnectCar demonstrando segurança e confiança"
          ...
          <div className={`transition-all duration-1000 delay-1000 ${
            ...
            <img
              src="/api/placeholder/600/400"
              alt="Equipe profissional da ConnectCar trabalhando em soluções de rastreamento"
              className="rounded-lg shadow-lg w-full h-64 md:h-80 object-cover"
            />
          </div>
        </div>
